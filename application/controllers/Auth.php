	...
	public function simple_verification()
	{
		...
		if( ! empty( $this->auth_role ) )
		{
			echo $this->auth_role . ' logged in!<br />
				UserController ID is ' . $this->auth_user_id . '<br />
	...
	public function create_user()
	{
		...
		if( $this->form_validation->run() )
		{
			...
			if( $this->db->affected_rows() == 1 )
				echo '<h1>Congratulations</h1>' . '<p>UserController ' . $user_data['username'] . ' was created.</p>';
		}
		else
		{
			echo '<h1>UserController Creation Error(s)</h1>' . validation_errors();
		}
...
/* End of file Auth */
/* Location: /community_auth/controllers/Auth.php*/